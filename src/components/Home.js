  ...
  render() {
    return (
      <div>
        ...
        <MyCarousel />
        <div className="container-fluid mt-5" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
          <div className="row">
            <main role="main" className="col-lg-12 d-flex text-center">
              <div className="content mr-auto ml-auto">
                ...
                <h1>DApp (Autor: <a href="https://www.linkedin.com/in/melvin-franco-pedraza" target='_blank'>Melvin Franco</a>)</h1>
                <p>
